...
audio_device="alsa_output.usb-Focusrite_Scarlett_Solo_USB_Y7B9HUW0596E51-00.HiFi__Line1__sink"
...
wf-recorder --audio=audio-device -c h264_vaapi -p r=60 -p crf=20 -f $HOME/Videos/Recordings/Recording-$current_date.mp4
